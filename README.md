...
|---|---|---|---|---|---|
| 第一批（訓練集） | 增刪卜易 45、卜筮正宗 8 | 53 | 75.5% | 60.4% | 15.1pp |
| 第二批（保留測試集） | 易隱 13、易冒 25、易林補遺 6、卜筮全書 6 | 48 | 58.3% | 47.9% | **10.4pp** |
| 全部 | | 101 | 67.3% | 54.5% | 12.8pp |

第二批擴充時刻意沒有據此調整任何參數，所以它才是誠實的泛化估計。它在訓練集與保留集上
的落差（75.5% vs 58.3%，領先基準 15.1pp vs 10.4pp）就是過擬合的實際規模——**要看引擎
有多少本事，看的是保留集那一行，不是第一批。** 保留集絕對命中率較低有一部分是因為它的
吉凶分布更平均、基準本來就低，但領先幅度也確實比訓練集小，這個差距不該被解釋掉。
